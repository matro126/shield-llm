...
OVERRIDES: dict = {
    "experiment": "en_2B_lora_FL-F_clinical_full_positive_b16",
    "results_dir": "training/en/Qwen-3-VL-2B-Instruct/lora/iu_xray_r2gen_FL-F/results_clinical_full_positive_b16",
    "training_strategy": "clinical",
    "training_phase": "clinical_only",
    "clinical_pretrain_epochs": 3,
    "clinical_rehearsal_ratio": 0.1,
    "clinical_balance": False,
    "clinical_include_fallback": True,
    "clinical_target_format": "positive_only",
