...
OVERRIDES: dict = {
    "experiment": "en_2B_lora_FL-F_clinical_resume_b16",
    "results_dir": "training/en/Qwen-3-VL-2B-Instruct/lora/iu_xray_r2gen_FL-F/results_clinical_resume_b16",
    "training_strategy": "clinical",
    "training_phase": "report_only",
    "clinical_pretrain_epochs": 0,
    "clinical_rehearsal_ratio": 0.1,
    "clinical_adapter_path": "training/en/Qwen-3-VL-2B-Instruct/lora/iu_xray_r2gen_FL-F/results_clinical_probe_b16/clinical_adapter",
    "lora_r": 32,
    "lora_alpha": 64,
    "lora_dropout": 0.0,
