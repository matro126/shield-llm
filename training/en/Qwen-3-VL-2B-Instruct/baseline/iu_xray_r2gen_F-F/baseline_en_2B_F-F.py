#!/usr/bin/env python3
"""Baseline ZERO-SHOT di Qwen/Qwen3-VL-2B-Instruct su dataset/iu-xray/en/iu_xray_en_F-F.
...
Questa baseline e' UNA per (modello, dataset) ed e' condivisa dagli esperimenti:
    ...
    en_2B_lora_F-F, en_2B_qlora_F-F
...
GENERATO da training/generate.py — non modificare il corpo a mano.
    ...
    python training/en/Qwen-3-VL-2B-Instruct/baseline/iu_xray_r2gen_F-F/baseline_en_2B_F-F.py

Risultati in training/en/Qwen-3-VL-2B-Instruct/baseline/iu_xray_r2gen_F-F/results/.
"""
